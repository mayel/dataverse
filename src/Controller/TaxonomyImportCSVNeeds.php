...
class TaxonomyImportCSVNeeds extends Taxonomy // TEMPORARY: used to import taxonomy data from a CSV with the following columns: Level 0,Level 1,Level 2,Level 3,Level 4,Level 5,Level 6,UN0,UN1,UN2,UN3,Google,eBay,NICE
{
